<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserControlPage.aspx.cs" Inherits="TorrentClient.UserControlPage" %>
...
<body>
    ...
    <div style="height:300px; overflow:scroll">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            ConnectionString="Data Source=localhost;Initial Catalog=ClientsDB;Integrated Security=True" 
            SelectCommand="SELECT * FROM [Clients]" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
            </div>
        <br />
        <br />
